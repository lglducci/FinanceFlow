  ...
  // Rotina salvar definitiva assim espero
   ...
   const index = lancamentos.findIndex(l =>
    ...
    try {
      ...
      alert(t("importacaoBancaria.lancamentosSalvos", "Lançamentos salvos!"));
...
const historicoCompleto = [memo, name]
  .filter(Boolean)
  .join(" - ") || t("importacaoBancaria.lancamentoOfx", "LANÇAMENTO OFX");
 ...
 useEffect(() => {
   ...
   selecionarConta(primeira);
                             ...
                             {contaAtual ? (
                               <button
                                 ...
                                 className={`
                                   ...
                                   flex items-center gap-4 transition hover:scale-[1.01]
                                 `}
                                 style={{
    ...
    <div className="flex items-center gap-2 mr-10">
      ...
      >
         {t("importacaoBancaria.salvar", "Salvar")}
      </button>
    </div>
  </div>
            </>
